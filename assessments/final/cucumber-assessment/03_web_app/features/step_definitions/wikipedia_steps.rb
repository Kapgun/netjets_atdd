...
Then(/^I am shown summaries of several recent news items on the dashboard$/) do
  @browser.span(:id => "In_the_news").exists?
  @browser.lis(:xpath => "//div[@id='mp-itn']/ul/li").length > 0
end
